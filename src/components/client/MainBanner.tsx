  ...
  return (
    <Fragment>
      ...
      >
        ...
        <button className="ml-30 bg-[#191970] h-12.5 p-3 mb-20 rounded-2xl font-bold hover:bg-[#256590] hover:scale-[1.05] active:bg-[#252550] active:scale-[1.0] shadow-md shadow-[#252550] transition-colors duration-300 ease-in-out">Зв'язатися з нами</button>
      </section>
    </Fragment>
  );
}
